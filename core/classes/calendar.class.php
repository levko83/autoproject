...
class Calendar
{
    ...
    */
    ...
    {
        return "/news/calendar/".$day.'-'.$month.'-'.$year;
    }
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<table class=\"calendar\" width=\"260\" cellpadding=\"0\" cellspacing=\"0\">\n";
    	$s .= "<tr>\n";
    	$s .= "<th height=\"30\" style=\"letter-spacing:2px;\">" . (($prevMonth == "") ? "&nbsp;" : "<a class=\"quotes\" href=\"$prevMonth\">&lt;</a>")  . "</th>\n";
    	$s .= "<th height=\"30\" style=\"letter-spacing:2px;\" colspan=\"5\">$header</th>\n";
    	$s .= "<th height=\"30\" style=\"letter-spacing:2px;\">" . (($nextMonth == "") ? "&nbsp;" : "<a class=\"quotes\" href=\"$nextMonth\">&gt;</a>")  . "</th>\n";
    	$s .= "</tr>\n";

    	$s .= "<tr class=\"thedays\">\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+1)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+2)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+3)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+4)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+5)%7] . "</td>\n";
    	$s .= "<td align=\"center\" valign=\"middle\" class=\"calendarHeader\">" . $this->dayNames[($this->startDay+6)%7] . "</td>\n";
    	$s .= "</tr>\n";
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
        	    $class = ($year == $today["year"] && $month == $today["mon"] && $d == $today["mday"]) ? "todays-date" : "days";
    	        $s .= "<td align=\"center\" valign=\"middle\">";
    	        if ($d > 0 && $d <= $daysInMonth)
    	        {
    	            $link = $this->getDateLink($d, $month, $year);
    	            $s .= (($link == "") ? $d : "<a class=\"$class\" href=\"$link\">$d</a>");
    	        }
    	        else
    	        {
    	            $s .= "&nbsp;";
    ...
    */
    ...
    /*
        ...
        represents Sunday.
    */
    var $dayNames = array("В", "П", "В", "С", "Ч", "П", "С");
